  ...
  const lyrics = [
    {
      index: 0,
      time: 0,
      Sanskrit: ["वसुदेवसुतं देवं कंसचाणूरमर्दनम्।", <br />, "देवकीपरमानन्दं कृष्णं वन्दे जगद्गुरुम्॥"],
      hindi: ["कंस और चाणूरका वध करने वाले, देवकीके आनन्दवर्धन, वसुदेवनन्दन जगद्गुरु श्रीकृष्णचन्द्रकी मैं वन्दना करता हूँ।"]
    },
    {
      index: 1,
      time: 52.000,
      Sanskrit: ["अजोऽपि सन्नव्ययात्मा भूतानामीश्वरोऽपि सन्।", <br />, "प्रकृतिं स्वामधिष्ठाय सम्भवाम्यात्ममायया॥"],
    ...
    },
    {
      index: 3,
      time: 133.051,
      Sanskrit: ["परित्राणाय साधूनां विनाशाय च दुष्कृताम्।", <br />, "धर्मसंस्थापनार्थाय सम्भवामि युगे युगे॥"],
    ...
    },
    {
      index: 4,
      time: 171.084,
      Sanskrit: ["जन्म कर्म च मे दिव्यमेवं यो वेत्ति तत्त्वत:।", <br />, "त्यक्त्वा देहं पुनर्जन्म नैति मामेति सोऽर्जुन॥"],
    ...
    },
    {
      index: 5,
      time: 208.098,
      Sanskrit: ["वीतरागभयक्रोधा मन्मया मामुपाश्रिता:।", <br />, "बहवो ज्ञानतपसा पूता मद्भावमागता:॥"],
    ...
    },
    {
      index: 6,
      time: 245.046,
      Sanskrit: ["वसुदेवसुतं देवं कंसचाणूरमर्दनम्।", <br />, "देवकीपरमानन्दं कृष्णं वन्दे जगद्गुरुम्॥", <br />, "कृष्णं वन्दे जगद्गुरुम्"],
      hindi: " कंस और चाणूरका वध करने वाले, देवकीके आनन्दवर्धन, वसुदेवनन्दन जगद्गुरु श्रीकृष्णचन्द्रकी मैं वन्दना करता हूँ।"
    },
    {
      index: 7,
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            marginTop: '20px',
            overflowY: 'auto',
            maxHeight: '300px', // Adjust height to show 5 lines
            display: 'flex',
          ...
          <div className="lyrics-column">
            {lyrics?.map((lyricx: any, index: any) => (
              <p
                ...
                }} onClick={() => handleLyricClick(index, lyricx.time)}>{lyricx.Sanskrit}</p>
            )
            )}
          </div>
        </div>
