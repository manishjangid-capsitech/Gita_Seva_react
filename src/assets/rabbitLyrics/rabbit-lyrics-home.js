...
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    class RabbitLyrics {
        ...
        constructor(options) {
            ...
            this.element.classList.add(['lyrics']);
            ...
            switch (this.viewMode) {
                case 'mini':
                    this.element.classList.add('lyrics-mini');
                    break;
                case 'full':
                    this.element.classList.add('lyrics-full');
                    break;
                default:
                    break;
            }
            ...
            for (let i = 0; i < lines.length; i++) {
                ...
                if (beginningTimeStamp.length > 0) {
                 ...
                 lineElement.addEventListener( 'click', function(){
                    ...
                    var x=parseFloat(lineElement.dataset.start)+parseFloat(0.01);
        ...
        enableLyrics() {
            ...
            this.element.classList.add(['lyrics-enabled']);
            ...
            this.lineElements.forEach(element => {
                if (time >= element.dataset.start && time <= element.dataset.end) {
                    ...
                    if (!element.classList.contains('active')) {
                        ...
                        if(myaudios!=null && myaudios.played)
                        {
                     
                        if (time >= "2.48" && time < "52.00")
                        {
                            var activeLines2 = $("#lineDiv1");
                            activeLines2.addClass("active");
                            $("#lineDiv1").show();
                            $("#lineDiv2").hide();
                            $("#lineDiv3").hide();
                            $("#lineDiv4").hide();
                            ...
                            else if (time >= "94.31" && time < "133.51") {
                                $("#lineDiv1").hide();
                                $("#lineDiv2").hide();
                                $("#lineDiv3").show();
                                $("#lineDiv4").hide();
                            ...
                            else if (time >= "133.51" && time < "171.84") {
                                $("#lineDiv1").hide();
                                $("#lineDiv2").hide();
                                $("#lineDiv3").hide();
                                $("#lineDiv4").show();
                            ...
                            else if (time >= "171.84" && time < "208.98") {
                                $("#lineDiv1").hide();
                                $("#lineDiv2").hide();
                                $("#lineDiv3").hide();
                                $("#lineDiv4").hide();
                            ...
                            else if (time >= "208.98" && time < "245.46") {
                                $("#lineDiv1").hide();
                                $("#lineDiv2").hide();
                                $("#lineDiv3").hide();
                                $("#lineDiv4").hide();
                            ...
                            else if (time >= "245.46" && time < "289.86") {
                                $("#lineDiv1").hide();
                                $("#lineDiv2").hide();
                                $("#lineDiv3").hide();
                                $("#lineDiv4").hide();
                            ...
                            else if (time >= "289.86" && time < "306.91") {
                                $("#lineDiv1").hide();
                                $("#lineDiv2").hide();
                                $("#lineDiv3").hide();
                                $("#lineDiv4").hide();
